...
tf.flags.DEFINE_string("mid_data_file", "./data/mid_5000.utf8", "Data source for the mid data.")
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_positive_negative_data_files(FLAGS.positive_data_file, FLAGS.negative_data_file, FLAGS.mid_data_file)
