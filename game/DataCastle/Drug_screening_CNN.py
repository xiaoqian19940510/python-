...
## conv2 layer ##第二卷积层
W_conv5 = weight_variable([2, 2, 256, 64])  # patch 2x2, in size 32, out size 64
...
h_pool5_flat = tf.reshape(h_conv5, [-1, 5 * 5 * 64])  # 把4*4，高度为64的三维图片拉成一维数组 降维处理
...
with tf.Session() as sess:
    ...
    pre_y.to_csv('taijing/result_traijing3.csv')
